...
/**
 * ReportmonthSearch represents the model behind the search form about `backend\models\Risk2datarisk`.
 */
class ReportmonthSearch extends Risk2datarisk
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['hnno', 'name', 'age', 'gender', 'departreport', 'departrespon', 'daterigter','date1','date2', 'timer', 'fromevent', 'dtevt', 'commen', 'typereport', 'notepatient', 'notehead', 'noteceo', 'notedepart', 'star', 'statusconfirm', 'datereport', 'daterespon'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            ...
            'pagination' => TRUE,
            'pagination' => [
                'pagesize' => 10  //กำหนดจำนวนแถวที่ต้องการให้แสดง
            ],             
        ]);
